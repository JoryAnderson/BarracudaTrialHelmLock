 ...
 * instead of the {@link com.arcaeic.osrs.BarracudaTrialAntiDrag.BarracudaTrialAntiDragPlugin} class handling everything.
 */
@Slf4j
@Singleton
...
public class ComponentManager
{
	...
	{
		if (!BarracudaTrialAntiDragConfig.CONFIG_GROUP.equals(e.getGroup()))
		{
			return;
		}
